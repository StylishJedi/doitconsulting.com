...
document.querySelectorAll('.about-item, .service-card, .partner-item').forEach(el => {
    el.style.opacity = '0';
...
// Add some mobile menu styles via JavaScript (since we don't have access to edit CSS after)
